...
## Notes
Added Figma MCP endpoint to source-managed .configs/codex-config.toml and README. Ran agents-infra setup global --source-dir ~/src/relux-works/relux-agents-infra. Verified codex mcp list/get figma and fresh codex exec Figma whoami/get_metadata for node 496:33323. Current already-running chat session still needs restart for direct MCP tools.
