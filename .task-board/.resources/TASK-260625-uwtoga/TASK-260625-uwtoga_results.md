...
- `alexis-agents-infra/.instructions/INSTRUCTIONS_WORKFLOW.md` now includes `Stop-The-Line: No Forced Fits`.
...
- `agents-infra setup global --source-dir /Users/alexis/src/relux-works/alexis-agents-infra` passed and rendered `/Users/alexis/.codex/AGENTS.md`.
